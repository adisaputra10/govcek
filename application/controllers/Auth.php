...
class Auth extends CI_Controller {
    ...
    function member(){
        ...
        else
        {
            ...
            $this->data['tb_users'] = $this->ion_auth->get_all_users();
            
            //$c = $this->ion_auth->users()->result(); echo '<pre>';print_r($c);die();
    ...
    function activate($id, $code = false) {
        ...
        //echo '...<pre>'; print_r($activation);die();
        if ($activation) {
    ...
    function create_user() {
        ...
        $this->data['company'] = $this->End_user_model->get_end_user();
        ...
        // validate form input
        $this->form_validation->set_message('is_unique', '%s allready exist');
    ...
    function register() {
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
            ...
            $this->session->set_flashdata('message', "Account allready created. Please check email for activation.");
            redirect("auth/login", 'refresh');
        } else {
            // display the create user form
            // set the flash data error message if there is one
    ...
    function edit_user($id) {
        ...
        $this->data['major_company'] = $this->End_user_model->get_end_user();        
        //$b = $this->End_user_model->get_end_user();
        //echo '<pre>';print_r($b);die();

        $a = $this->End_user_model->get_by_id_user($id);
        $this->data['id_major'] =  $a->major_id;
