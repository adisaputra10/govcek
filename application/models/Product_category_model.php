...
class Product_category_model extends CI_Model {
    ...
    public $table_checklist = 'product_category_checklist';
    public $id = 'id';
    public $cat = 'product_category';
    public $order = 'ASC';
    ...
    function update_checklist($id, $data){
        echo $id; echo '<pre>';print_r($data);
        $this->db->where($this->id, $id);
        $this->db->update($this->table_checklist, $data);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2017-09-14 11:09:25 */