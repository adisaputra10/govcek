...
class Schedule_model extends CI_Model {
    ...
    function get_new_schedule($dos, $int)
    {
        $kueri = "SELECT DATE_ADD('".$dos."',".$int.") as new_schedule";
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-10-14 11:09:25 */