...
class Ion_auth_model extends CI_Model {
    ...
    public function activate($id, $code = false) {
        ...
        //echo '>>>>>> '.$this->identity_column.'/'.$id.'/'.$code;die();
        
        if ($code !== FALSE) {
            $kueri = "SELECT ".$this->identity_column." FROM tb_users WHERE activation_code = ".$code." AND id = ".$id." LIMIT 1 ORDER BY id, desc";
            die($kueri);
    ...
    public function login($identity, $password, $remember = FALSE) {
        //echo '-->'.$identity.'/'.$password.'/'.$remember; //die();
        $this->trigger_events('pre_login');

        if (empty($identity) || empty($password)) { //die('tes');
    ...
    function get_all_users() {
        ...
        $kueri = " 
            SELECT tu.*, eu.company
            FROM 
                tb_users tu
                LEFT JOIN end_user eu ON tu.major_id = eu.id";
