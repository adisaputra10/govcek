 ...
 */
$config['site_title'] = "My Govcek";       // Site Title, example.com
$config['admin_email'] = "noreplyt@govcek.id"; // Admin Email, admin@example.com
...
$config['email_config'] = array( 'mailtype' => 'text', 
    'protocol' => 'smtp', 
    'smtp_host' => 'mail.govcek.id', 
    'smtp_port' => 587 , 
    'smtp_timeout'=>'30', 
    'smtp_user' => 'noreply@govcek.id', 
    'smtp_pass' => 'albalifting',
    'mailtype' => 'html', 
    'charset' => 'utf-8', 
    'newline' => '\r\n',
);
